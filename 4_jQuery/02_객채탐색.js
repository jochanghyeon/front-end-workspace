...
$("h4:odd").css({ "background-color": "hotpnk", color: "white" });
...
// nextUntil(['선택자']) : 선택된 요소와 같은 레벨 요소 중 다음의 모든 요소를 선택하거나, 매개변수가 있으면 같은 레벨의 다음 요소 중 매개변수와 일치하는 요소 까지 선택

function btn1() {
  console.log("최소값 : ", Math.min(5, 7, -1, -6)); //최소값을 알려줌! -6
  console.log("최대값 : ", Math.max(5, 7, -1, -6)); //최대값을 알려줌! 7
  console.log("절대값 : ", Math.abs(-8.878787)); //절대값을 알려줌! 8787878
}
...
function btn8() {
  ...
  location.href = "http://www.naver.com"; //해당페이지로 이동
}
